...
class Game {
    constructor(start) {
        ...
        document.getElementById('start').addEventListener('click', this.startGame.bind(this)); //bind przywiązuje thisa czyli tutaj input,bez binda this to button
    ...
    startGame() {
        if(this.inputBid.value < 1) return alert("kwota, którą chcesz grać jest za mała!");
            ...
            if(!this.wallet.checkCanPlay(bid)){
                return alert("masz za mało środków lub podana została nieprawidlowa wartość");
            }
